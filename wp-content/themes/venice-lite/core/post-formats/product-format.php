...
if ( $image ) :
	...
	$html .= '<img src="'.$image[0].'" class="attachment-blog wp-post-image" alt="'.esc_attr(get_post_meta(get_post_thumbnail_id()), '_wp_attachment_image_alt', true).'">';
	$html .= '</div>';
...
if ( venicelite_postmeta( '_sale_price' ) ) :	
