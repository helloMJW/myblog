<?php
    ...
    */
    ...
    function powr_rss_feed_options() {
      ...
      echo '<iframe id="powr-rss-feed" src="https://www.powr.io/wp-create/rss-feed" frameborder="0" width="100%" height="600px" style="position:absolute; top:0; left:0;z-index: 100;"></iframe>';
      echo '<script>';
