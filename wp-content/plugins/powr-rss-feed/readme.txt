...
<br>
<br>
First, download, install, and activate POWr RSS Feed. Then drop the plugin anywhere in your theme. Or add to a page/post with the POWr icon in the WP editor.
<br>
= <a href='https://www.powr.io/tutorials/how-to-add-rss-feed-plugin-to-your-wordpress-site'>Click Here for 2 Minute Install Tutorial</a> =
<br>
= Free Features =
...
In your WP Dashboard, select Appearance > Widgets from the left sidebar. Find RSS Feed under Available Widgets and drag it into a sidebar or footer.  Then visit the live page to set up the plugin.
