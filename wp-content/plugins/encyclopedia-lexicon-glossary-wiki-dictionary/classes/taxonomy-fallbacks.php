...
abstract class Taxonomy_Fallbacks {
  ...
  static function init(){
    add_Filter('get_the_categories', Array(static::class, 'Filter_Get_The_Categories'), 10, 2);
    add_Filter('the_category', Array(static::class, 'Filter_The_Category'), 10, 3);
    add_Filter('get_the_tags', Array(static::class, 'Filter_Get_The_Tags'));
    add_Filter('the_tags', Array(static::class, 'Filter_The_Tags'), 10, 5);
  }
